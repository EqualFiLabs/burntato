...
contract DeployBurntatoRobinhoodTestnet is DeployBurntato {
    ...
    uint16 public constant PRICE_INCREASE_BPS = 100;
    uint256 public constant ROUND_TIMEOUT = 10 minutes;
    uint256 public constant ROUND_TIMEOUT_DECAY = 1 minutes;
    uint256 public constant MINIMUM_ROUND_TIMEOUT = 1 minutes;
    ...
    function testnetConfig(address deployer) public pure returns (GenesisConfig memory config) {
        ...
        config.protocol.startingPrice = STARTING_PRICE;
        config.protocol.priceIncreaseBps = PRICE_INCREASE_BPS;
        config.protocol.roundTimeout = ROUND_TIMEOUT;
        config.protocol.roundTimeoutDecay = ROUND_TIMEOUT_DECAY;
        config.protocol.minimumRoundTimeout = MINIMUM_ROUND_TIMEOUT;
    ...
    function _writeDeployment(
        ...
        vm.serializeAddress(object, "proposer", config.proposer);
